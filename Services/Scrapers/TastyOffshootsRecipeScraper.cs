...
{
    public class TastyOffshootsRecipeScraper : RecipeScraper
    {
        private TastyOffshootsRecipeScraper()
        {
        }

        public static RecipeScraper Instance { get; } = new TastyOffshootsRecipeScraper();
